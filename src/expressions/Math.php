...
require_once 'expressions/TerminalExpression.php';
require_once 'expressions/Operator.php';
require_once 'expressions/Addition.php';
require_once 'expressions/Subtraction.php';
require_once 'expressions/Division.php';
require_once 'expressions/Multiplication.php';
require_once 'expressions/Parenthesis.php';
require_once 'expressions/Number.php';
